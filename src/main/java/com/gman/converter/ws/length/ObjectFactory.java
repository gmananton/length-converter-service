 ...
 * generated in the com.gman.converter.ws.length package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.gman.converter.ws.length
     * 
     */
